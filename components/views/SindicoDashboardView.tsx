      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <div className="flex items-center gap-4 mb-3">
            <div className="p-3 bg-white/10 border border-white/20 rounded-2xl text-white shadow-lg">
          ...
          <div className={`premium-glass rounded-[32px] p-8 border transition-all hover:scale-[1.01] ${getStatusColor(metrics.openOccurrences, { good: 0, warning: 1 })}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              {metrics.openOccurrences > 0 && (
                <span className="px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest bg-white/20 text-white animate-pulse">
                  Ação Necessária
                </span>
              )}
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="premium-glass rounded-[20px] p-5 border border-[var(--border-color)]">
            ...
            <p className="text-2xl font-black text-[var(--text-primary)]">
              94% <span className="text-[10px] text-white">▲</span>
            </p>
          </div>
          <div className="premium-glass rounded-[20px] p-5 border border-[var(--border-color)]">
            <span className="text-[9px] font-black uppercase text-[var(--text-secondary)] block mb-2">
            ...
            <p className="text-2xl font-black text-[var(--text-primary)]">
              2.1% <span className="text-[10px] text-white">▼</span>
            </p>
          </div>
          <div className="premium-glass rounded-[20px] p-5 border border-[var(--border-color)]">
            <span className="text-[9px] font-black uppercase text-[var(--text-secondary)] block mb-2">
