...
const Layout: React.FC<LayoutProps> = ({
  ...
  const menuItems = [
    ...
    { id: 'packages', label: 'Encomendas', icon: Package, roles: ['PORTEIRO', 'SINDICO'] },
    ...
    <div className="flex flex-col h-full">
      <div className={`p-8 flex items-center transition-all duration-500 ${isDesktopCollapsed ? 'px-4 justify-center' : 'justify-between'}`}>
        ...
        >
          ...
          {!isDesktopCollapsed && (
            <div>
              <h1 className="text-2xl font-black tracking-tighter shimmer-text leading-none">GESTÃO DE CONDOMÍNIO</h1>
